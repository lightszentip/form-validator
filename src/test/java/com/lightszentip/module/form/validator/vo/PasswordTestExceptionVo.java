...
public class PasswordTestExceptionVo {

    @PasswordApproved(strategy = PasswordStrategy.class)
    private String password;

    public PasswordTestExceptionVo() {
    }
    ...
    public PasswordTestExceptionVo(String password) {
        super();
        this.password = password;
    }
